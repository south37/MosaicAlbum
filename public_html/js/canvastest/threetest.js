...
$(function() {
  return window.addEventListener("DOMContentLoaded", function() {
    var anim, aspect, camera, col, controlMode, directioalLight, far, fov, geometry, height, i, j, materials, near, path, pathList, pclientX, pclientY, piece, pieces, projector, renderer, rendering, row, scene, sizeX, sizeY, target, tex, texlist, tmppieces, trackball, trans, width, _i, _j;
