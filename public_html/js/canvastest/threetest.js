...
$(function() {
  return window.addEventListener("DOMContentLoaded", function() {
    var mosaicImagePath, originalImagePath, selectedImagePath;
    $('#showMosaic').tooltip({
      placement: 'top',
      title: 'くりっくしてね',
      triger: 'hover'
