...
$(function() {
  return window.addEventListener("DOMContentLoaded", function() {
    var content, mosaicContentsStr, options;
    options = {
      placement: 'top',
      title: 'くりっくしてね！',
      triger: 'hover'
    ...
    $('#modal1 .modal-header').empty().append("<h3>members:xx,oo</h3>").append('<button id="closeModal" class="btn">x</button>');
    ...
    $('#showModal').click(function() {
      $('#modal1').modal('toggle');
      return console.log(mosaicContentsStr);
    });
