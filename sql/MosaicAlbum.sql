# MosaicAlbum		データベースを作成し、そのデータベースに入る
CREATE DATABASE MosaicAlbum;
USE MosaicAlbum;
# goal_image
CREATE TABLE goal_image(id INT AUTO_INCREMENT PRIMARY KEY, fb_goal_image_id INT, mosaic_path VARCHAR(255), is_make_mosaic BOOLEAN);
# user
